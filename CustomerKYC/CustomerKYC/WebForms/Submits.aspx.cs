...
namespace CustomerKYC.WebForms
{
    public partial class Submits : System.Web.UI.Page
    {
        ...
        protected void View_OnClick(object sender, EventArgs e)
        {
            ...
            Response.Write("<th  style = 'text-align: center;'>ApplicantID</th>");
            ...
            while (rdr1.Read())
            {
                ...
                Response.Write(string.Format("{0}", rdr1["ApplicantID"].ToString()));
                Response.Write("</td>");
                Response.Write("<td style = 'text-align: center;'>");
                Response.Write(string.Format("{0}", rdr1["FirstName"].ToString()));
                Response.Write("</td>");
                Response.Write("<td style = 'text-align: center;'>");
                Response.Write(string.Format("{0}", rdr1["MiddleName"].ToString()));
                Response.Write("</td>");
                Response.Write("<td style = 'text-align: center;'>");
                Response.Write(string.Format("{0}", rdr1["LastName"].ToString()));
                Response.Write("</td>");
                Response.Write("<td style = 'text-align: center;'>");
                Response.Write(string.Format("{0}", rdr1["PAN_Number"].ToString()));
                Response.Write("</td>");
                Response.Write("<td style = 'text-align: center;'>");
                Response.Write(string.Format("{0}", rdr1["AADHAR_Number"].ToString()));
                Response.Write("</td>");
                Response.Write("<td style = 'text-align: center;'>");
                Response.Write(string.Format("{0}", rdr1["PASSPORT_Number"].ToString()));
                Response.Write("</td>");
