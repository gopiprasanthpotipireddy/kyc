...
namespace CustomerKYC.WebForms
{
    public partial class Registration : System.Web.UI.Page
    {
        ...
        protected void verify(object sender, EventArgs e)
        {
            ...
            //    con.Open();
            //    SqlCommand cmd = new SqlCommand("insert into Applicant_Details values(@FirstName, @MiddleName,  @LastName, @PAN_Number,@AADHAR_Number,@PASSPORT_Number) ");
              
            //    cmd.Parameters.AddWithValue("FirstName", first_name.Value);
            //    cmd.Parameters.AddWithValue("MiddleName", mid_name.Value);
            //    cmd.Parameters.AddWithValue("LastName", last_name.Value);
            //    cmd.Parameters.AddWithValue("PanNumber", pan_num.Value);
            //    cmd.Parameters.AddWithValue("AadharNumber", aadhar_num.Value);
            //    cmd.Parameters.AddWithValue("PassportNumber", pass_num.Value);
            //    cmd.ExecuteNonQuery();
