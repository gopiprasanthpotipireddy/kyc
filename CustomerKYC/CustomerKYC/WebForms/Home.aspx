<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Home.aspx.cs" Inherits="CustomerKYC.WebForms.Home" %>
...
<head>
  ...
  <!-- Favicons -->
  <link id ="link1" href="../img/favicon.png" rel="icon"/>
  <link id="link2" href="../img/apple-touch-icon.png" rel="apple-touch-icon"/>

  <!-- Google Fonts -->
  <link id="link3" href="https://fonts.googleapis.com/css?family=Ruda:400,900,700" rel="stylesheet"/>

  <!-- Bootstrap CSS File -->
  <link  id="link4"  href="../lib/bootstrap/css/bootstrap.min.css" rel="stylesheet"/>

  <!-- Libraries CSS Files -->
  <link id="link5"  href="../lib/font-awesome/css/font-awesome.min.css" rel="stylesheet"/>
  <link id="link6"  href="../lib/prettyphoto/css/prettyphoto.css" rel="stylesheet"/>
  <link id="link7" href="../lib/hover/hoverex-all.css" rel="stylesheet"/>
  <link id="link8"  href="../lib/jetmenu/jetmenu.css" rel="stylesheet"/>
  <link id="link9"  href="../lib/owl-carousel/owl-carousel.css" rel="stylesheet"/>

  <!-- Main Stylesheet File -->
  <link id="link10" href="../css/style.css" rel="stylesheet"/>
  <link id="link11" rel="stylesheet" href="../css/colors/blue.css"/>
      ...
      <div class="container">
        <div class="col-lg-6 col-md-6 col-sm-12 columns footer-left">
          ...
          <div class="credits">
            ...
            -->
            Created with KYC template by <a href="https://templatemag.com/">TemplateMag</a>
          </div>
        </div>
        <!-- end widget -->
