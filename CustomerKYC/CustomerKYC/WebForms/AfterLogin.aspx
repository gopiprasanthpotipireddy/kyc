<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AfterLogin.aspx.cs" Inherits="CustomerKYC.WebForms.AfterLogin" %>
      ...
      <div id="sidebar" class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
        ...
        <div class="widget">
          ...
          <form id="subscribe"  name="subscribe" action="iframe.aspx" method="post">
            <p><h3 style="color:black;font-family:'Times New Roman', Times, serif;">Please click here to intiate KYC for a new client.</h3></p>
              <%--<input type="text" name="name" id="name" class="form-control" placeholder="Name">
            <input type="text" name="email" id="email" class="form-control" placeholder="Email">--%>
            <div class="pull-right" align="center">
              <%--<input type="submit" value="NewCase" style="position:center;" id="submit" class="button">--%>
      <asp:Button ID="submit" runat="server" Text="NewCase" CssClass="button" style="position:center;" />
                      </div>
