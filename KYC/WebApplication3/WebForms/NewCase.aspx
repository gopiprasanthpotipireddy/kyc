        ...
        <form runat="server">
            <div class="main">
                <div class="tab">
                    ...
                    <input id="Button1" runat="server" type="button" onserverclick="submit_OnClick" style="background-color:orange;height:52px; width:155px;position:absolute; top:65px; right:300px;" value="submit" /></div>
                            ...
                            <div class="panel panel-default">
                                ...
                                <div id="collapseOne" class="panel-collapse collapse">
                                 ...
                                 <asp:ListItem>No</asp:ListItem>
                                                ...
                                                <%-- <td>  <input id="Button1" runat="server" type="button" onserverclick="submit_OnClick" style="background-color:white;height:50px; width:120px;" value="submit" /></td>--%>
                                                <td></td>
                                            </tr>
                                        </table>
                                        </p>
