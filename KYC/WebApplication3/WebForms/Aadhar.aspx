<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Aadhar.aspx.cs" Inherits="WebApplication3.Aadhar" %>
...
<body>
 ...
 <a  href="#Home" target="iframe">ENROLL & GET AADHAAR</a>
  <a href="#news" target="iframe">AADHAR VERIFICATION</a>
  <a href="#contact" target="iframe">Contact</a>
  <a href="#about" target="iframe">About</a>
   </div>
   <div class="main">
